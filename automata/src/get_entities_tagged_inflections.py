...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Input file with entities (output of get_entites_with_typeflags.py).",
    )
    parser.add_argument(
        "-o",
        "--output",
        type=str,
        required=True,
        help="Output file with tagged and inflected entities.",
    )
    ...
    try:
        ...
        print(
            f"ERROR in tagged inflections for entities: No implementation for given language. (Detail: {e})",
            flush=True,
            file=sys.stderr,
        )
        sys.exit(1)
